...
#网络结构载入：network_dat.pkl
def load_network(path='/home/wanghz/EC_V1/data/GLIF_V1_network/network_dat.pkl',#节点和边数据
...
#从 pkl 文件加载外部输入 spike trains
def load_input(path='/home/wanghz/EC_V1/data/GLIF_V1_network/input_dat.pkl',
               start=0,
               duration=3000,
               dt=1,
...
#把输入群体减少到 new_n_input重新合并indice和weight
...
#给 network 加上 cortical laminar population 的 neuron 索引
